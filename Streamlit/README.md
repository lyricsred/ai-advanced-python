...
| Параллельно (процессы) | 0.386 сек | 1.76x |
| Параллельно (потоки) | 0.276 сек | 1.26x |
...
Получить новые результаты синхронного и асинхронного анализа можно в приложении.
...
**Выводы**: Для множественных запросов асинхронный метод значительно быстрее, так как позволяет выполнять запросы параллельно. Однако в рамках запроса по одному городу, преимущество от асинхронности не достигается.

Получить новые результаты сихнронных и асинхронных запросов для 5 городов сразу можно в приложении.
